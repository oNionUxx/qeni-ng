...
export class ProductService {
    ...
    addProduct(product: Product) {
        let isAlreadyAdded = this.products.find((currProduct) => currProduct.id === product.id);
        console.log(product);
        if (isAlreadyAdded) {
            this.products.find((currProduct) => currProduct.id === product.id).quantity += product.quantity;
        } else {
    ...
    removeProduct(product: Product) {
        const productToBeDeleted = this.products.findIndex((currProduct) => currProduct.id === product.id);
    ...
    addQuantity(product: Product) {
        this.products.find((currProduct) => currProduct.id === product.id).quantity++;
        this.updateLocalStorage();
    }
